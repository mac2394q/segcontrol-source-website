...
$(document).ready(function () {
	...
	//COMPRAR Y CONTACTO
    var $buythemediv = '<div class="quick-question xs-display-none" hidden><a href="mailto:info@contact.com?subject=H-Code Quick Question"><span>Quick Question?</span></a></div>';
    $('body').append($buythemediv);

	/*<div class="buy-theme xs-display-none"><a href="http://themeforest.net/item/hcode-multipurpose-onepage-multi-page-template/11717596?ref=themezaa" target="_blank"><span>Purchase Theme</span></a></div>*/
